...
{
    public partial class Ipresence_Db_Creation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Semester_Programs_ProgramId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttendanceMark = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ClassId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Student_activity_Classes_ClassId",
                        column: x => x.ClassId,
                        principalTable: "Classes",
                        principalColumn: "ClassId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Student_activity_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Student_activity_ClassId",
                table: "Student_activity",
                column: "ClassId");

            migrationBuilder.CreateIndex(
                name: "IX_Student_activity_StudentId",
                table: "Student_activity",
                column: "StudentId");
